const ListePays = function(){
  ...
  const listeFr = JSON.parse(JSON.stringify(liste));
  ...
  const toutes = () => {
    return {
      ...
      'fr': ['France', getListeFr()]
    };
  };

  return {getListe, getListeFr, getListeEU, getListeNonEU, getListeAmeriques, getListeEurope, toutes};
